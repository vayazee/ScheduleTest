...
public class ScheduleHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sql.append("schedule_id integer primary key autoincrement");
        sql.append(",baby_id int(20)");
        sql.append(",mom_id int(20)");
        sql.append(",sc_year int(20)");
        sql.append(",sc_month int(20)");
        sql.append(",sc_date int(20)");
        sql.append(",sc_hour int(20)");
        sql.append(",sc_minute int(20)");
        sql.append(",sc_content varchar(500)");
        sql.append(");");
